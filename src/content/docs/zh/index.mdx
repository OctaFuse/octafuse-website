...
sidebar:
  hidden: true
hero:
  tagline: 把「接模型、控成本、保稳定、可追溯」做成团队共享的一层能力，而不是散落在每个业务系统里各自实现。
  actions:
    - text: 阅读文档
      link: /zh/docs/
      icon: right-arrow
...
<CardGrid stagger>
	<Card title="统一入口，兼容多生态" icon="rocket">
	...
	<Card title="路由策略与韧性" icon="open-book">
		按业务需要配置模型与优先级；在上游波动或故障时，提供更有弹性的切换与降级路径，减少「单点绑死在一个模型上」的脆弱性。
	</Card>
	<Card title="运营侧可观测与自检" icon="document">
