...
![供应商粘性设置窗口，包含启用开关、空闲有效期和启用后的路由行为说明。](/screenshots/v2-3-0-provider-sticky-settings.jpg)
...
![路由配置的拓扑视图，展示多个路由组、优先级层、供应商目标、策略和粘性状态。](/screenshots/v2-3-0-route-topology.jpg)
...
![已启用供应商粘性的设置窗口，展示绑定分布、用户绑定查询与整池绑定清理操作。](/screenshots/v2-3-0-provider-sticky-bindings.jpg)
