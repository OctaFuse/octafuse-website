...
![Qwen Audio 3.0 TTS Plus 从 OpenAI 音频请求入口路由到 Alibaba Cloud 上游](/screenshots/v2-4-0-dashscope-tts-route.webp)
...
![Integration Keys 页面展示从旧 MASTER_KEY 迁移生成的 legacy-master](/screenshots/v2-4-0-integration-keys.webp)
