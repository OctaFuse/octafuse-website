---
title: OctaFuse
description: A self-hostable open-source AI capability gateway and operations control plane. Unify Chat, Responses, images, audio, and Agent Tools with Surface → Pool → Target routing, budgets, billing, and audit. Supports Cloudflare Workers + D1 and Docker / Postgres / MySQL. AGPLv3.
template: splash
sidebar:
  hidden: true
hero:
