...
1. **Billing**: set default **charged to user** and **supplier cost** factors on the Target. Add a **Daily schedule** for vendor peak / off-peak pricing. A matching row overrides the defaults; its timezone comes from [System config](/en/docs/guides/system-config/).
...
<figure class="of-doc-figure">
	<img src="/screenshots/v2-6-0-route-billing-schedule.webp" alt="OctaFuse route editor showing client mapping, upstream mapping, default billing factors, and Daily schedule windows." loading="lazy" />
	<figcaption>Open any Upstream Target to review protocol mapping, catalog rates, default Charged / Metered factors, and Daily schedule overrides on one page.</figcaption>
</figure>

## Default factors and Daily schedule
