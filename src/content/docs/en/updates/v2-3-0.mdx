...
<figure class="of-doc-figure">
	<img src="/screenshots/v2-3-0-provider-sticky-settings.webp" alt="Provider sticky settings with the enable control, idle TTL, and an explanation of the routing behavior." loading="lazy" />
...
<figure class="of-doc-figure">
	<img src="/screenshots/v2-3-0-route-topology.webp" alt="Routes Topology view showing multiple route groups, priority tiers, upstream targets, policies, and sticky status." loading="lazy" />
...
<figure class="of-doc-figure">
	<img src="/screenshots/v2-3-0-provider-sticky-bindings.webp" alt="Enabled Provider sticky settings showing binding distribution, user binding lookup, and Pool-wide binding invalidation." loading="lazy" />
