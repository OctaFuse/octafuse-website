...
![OpenAI Responses request surface and models that are not yet connected to a route](/screenshots/v2-5-0-responses-overview-unrouted.webp)
...
![Routes workspace showing the default and free route groups for Qwen3.7 Plus](/screenshots/v2-5-0-routes-by-model.webp)
...
![Route editor showing the client surface, upstream mapping, custom parameters, and billing multipliers](/screenshots/v2-5-0-route-editor.webp)
...
![Provider cards showing protocol capabilities, key status, and route counts](/screenshots/v2-5-0-provider-cards.webp)
