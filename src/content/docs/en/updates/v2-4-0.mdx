...
<figure class="of-doc-figure">
	<img src="/screenshots/v2-4-0-dashscope-tts-route.webp" alt="Qwen Audio 3.0 TTS Plus routed from the OpenAI audio request surface to an Alibaba Cloud upstream" loading="lazy" />
...
<figure class="of-doc-figure">
	<img src="/screenshots/v2-4-0-integration-keys.webp" alt="Integration Keys showing the legacy-master credential migrated from the previous MASTER_KEY" loading="lazy" />
